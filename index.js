...
if (BOT_TOKEN == '8309865751:AAGtAH2TA7t8S7X_F8EBJizCwfPGTUAg31M') {
    ...
    try {
        ...
        if (profilePhotos.photos.length > 0) {
            ...
            await XeonBotInc.replyWithPhoto(ownerPhoto, {
                ...
                reply_markup: {
                    inline_keyboard: [
                        [{ text: 'OWNER', url: "https://t.me/B_o_d_a1FR" }, { text: 'CHANNEL', url: "https://t.me/b_o_d_a1FS" }, { text: 'GROUP', url: "https://t.me/b_o_da12" }]
                    ]
                }
            });
        } else {
        ...
        await XeonBotInc.reply(lang.first_chat(BOT_NAME, user.full_name), {
            ...
            reply_markup: {
                inline_keyboard: [
                    [{ text: 'OWNER', url: "https://t.me/B_o_d_a1FR" }, { text: 'GROUP', url: "https://t.me/b_o_da12" }]
                ]
            }
        });
    }
...
(async () => {
    try {
        // 👈 أضف السطر ده
        global.currentPhone = "967714570873"; // رقمك بدون +
